...
`)}return[t,r]}var appointmentsChanged=!1;const defaultAppointmentContext="both";var datesChecked=[],readingRooms=null,readingRoom=null,OnAppointmentEditForm=!1,OnViewAppointmentsPage=!1,RequestLinkAppt="#RequestLink";window.addEventListener("load",async function(){var t,n;document.getElementById("ReadingRoomID").innerHTML="";document.getElementById("AppointmentDate").value=null;document.getElementById("Name").value=null;t=document.getElementById("RequestLinkAppt");typeof t!="undefined"&&t!=null?RequestLinkAppt="#RequestLinkAppt":document.querySelector(RequestLinkAppt)==null&&(RequestLinkAppt=document.querySelector("[data-ead-name='RequestLink']")!=null?"[data-ead-name='RequestLink']":"[name='RequestLink']");let i=document.getElementsByTagName("form");for(let n of i)n.name=="EditAppointment"&&(OnAppointmentEditForm=!0);if(OnViewAppointmentsPage=document.getElementById("AppointmentID")==null,(OnViewAppointmentsPage||getComputedStyle(document.getElementById("AppointmentID")).position!=="fixed")&&(document.getElementById("NewAppointment")==null||getComputedStyle(document.getElementById("NewAppointment")).position!=="fixed")&&(document.getElementById("ReadingRoomID")==null||getComputedStyle(document.getElementById("ReadingRoomID")).position!=="fixed")||console.log("The AppointmentID, NewAppointment, and/or ReadingRoomID elements have a fixed position and their visibility may not be accurately determined by appointments.js"),n=document.getElementById("Site"),n.tagName.toLowerCase()=="select"&&(document.getElementById("Site").onchange=async function(){GetReadingRooms()}),document.getElementById("ReadingRoomID").onchange=function(){window.readingRoom=readingRooms.filter(n=>n.ID===document.getElementById("ReadingRoomID").value)[0];SetAppointmentRequiredLabel();GetAppointments().then(async()=>{await RefreshDatePicker()}).then(()=>{moment(document.getElementById("AppointmentDate").value).format("YYYY-MM-DD")in readingRoom.appointmentAvailability||(document.getElementById("AppointmentDate").value=null)})},document.getElementById("AppointmentDate").onchange=function(){FilterAppointmentLengthMenu()},document.getElementById("AppointmentLength").onchange=function(){UpdateAppointmentTimeSelect().then(()=>{RecalculateAppointmentTimes()})},document.getElementById("AppointmentTime").onchange=function(){document.getElementById("AppointmentTime").setAttribute("data-persisted-value",document.getElementById("AppointmentTime").value);RecalculateAppointmentTimes(!1)},OnViewAppointmentsPage&&(document.getElementById("ScheduleNewAppointment").onclick=function(){var n=document.getElementById("Site");OnViewAppointmentsPage&&n.tagName.toLowerCase()=="select"&&n.selectedIndex==0&&(n.selectedIndex=1,n.onchange())}),OnAppointmentEditForm)GetReadingRooms();else{if(document.querySelector(RequestLinkAppt).onchange=async function(){await GetAppointments().then(()=>{GetReadingRooms()})},document.querySelector(RequestLinkAppt).value==""&&(OnViewAppointmentsPage||(document.getElementById("AppointmentID").innerHTML="")),document.getElementById("NewAppointment")&&(document.getElementById("NewAppointment").onclick=async function(){EnableField("AppointmentDate");EnableField("AppointmentLength");EnableField("AppointmentTime");await RefreshDatePicker()}),n=document.getElementById("Site"),n.tagName.toLowerCase()=="select"&&n.options.length<2)for(let n of document.getElementsByClassName("sites-enabled"))n.classList.add("d-none");document.getElementById("CreateAppointmentButton").onclick=CreateAppointment;GetReadingRooms()}OnAppointmentEditForm||document.getElementById("CancelAppointmentCreateButton")!=null&&document.getElementById("CancelAppointmentCreateButton").addEventListener("click",function(){var n=document.querySelector("button#ScheduleNewAppointment");if(n==null&&(n=document.querySelector("button#NewAppointment")),n!=null&&n.focus(),OnViewAppointmentsPage){for(let n of document.querySelector(RequestLinkAppt).options)n.defaultSelected&&(document.querySelector(RequestLinkAppt).value=n.value);document.getElementById("Site").tagName.toLowerCase()=="select"&&(document.getElementById("Site").selectedIndex=0);document.getElementById("AppointmentDate").value="";document.getElementById("Name").value="";document.getElementById("AvailableToProxies").checked=!1}else document.getElementById("AppointmentDate").value="",document.getElementById("Name").value="",document.getElementById("AvailableToProxies").checked=!1})})